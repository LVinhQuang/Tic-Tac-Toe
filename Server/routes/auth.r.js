...
router.get('/google/callback',passport.authenticate('google', {failureRedirect: '/google/failure'}), function(req,res) {console.log(req.user); res.redirect(process.env.CLIENT_URL)})
